% 2peak: increased coding accuracy at adaptor & 90deg off
...
negLog_adapt_prior( params0, x, k_o, theta_o, kappa_o, theta, kappa_i, kappa_e, adaptor_45(1), test_45, dtheta_45, nTot_exp_45, nRight_exp_45, adaptor_225(1), test_225, dtheta_225, nTot_exp_225, nRight_exp_225, res, epsilon )
profile on
[fit_params, negLog_exp] = fminsearchbnd(@(params)negLog_adapt_prior( params, x, k_o, theta_o, kappa_o, theta, kappa_i, kappa_e, adaptor_45(1), test_45, dtheta_45, nTot_exp_45, nRight_exp_45, adaptor_225(1), test_225, dtheta_225, nTot_exp_225, nRight_exp_225, res, epsilon ),params0,vlb,vub)
profile off
...
save(['fit_' FIT_VER '_4522.5_sub' num2str(subj) '.mat'], 'theta', 'k21', 'pmin', 'k', 'kappa', 'negLog_exp', 'BIC_exp', 'x', 'fit_kernel', 'thresh_exp_pred_45', 'thresh_exp_pred_225');
